 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector("._slider-kazan")) new core("._slider-kazan", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("._slider-cheboksary")) new core("._slider-cheboksary", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector("._slider-ulyanovsk")) new core("._slider-ulyanovsk", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
